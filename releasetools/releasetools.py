def FullOTA_Assertions(info):
    ...
    info.script.AppendExtra('ifelse(file_getprop("/vendor/build.prop","ro.vendor.build.date.utc") != "1564381683",');
    ...
    info.script.AppendExtra('ui_print("          Expected version: XXU6CSGD         ");');
    info.script.AppendExtra('ui_print("=============================================");');
